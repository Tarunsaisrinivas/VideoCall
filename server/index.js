...
import authRoute from "./routes/authRouter.js"; // Import authentication routes (login/signup)
import userRoute from "./routes/userRouter.js"; // Import user-related routes (profile, settings)
import dbConnection from "./db/db.js"; // Import function to connect to MongoDB database
